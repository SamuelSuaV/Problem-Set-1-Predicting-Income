...
\end{center}
\footnotesize Al fijar edad y educación la brecha \textbf{se amplía} (rojo): las mujeres de la muestra tienen más educación terciaria (\PctTertiaryWomen\,\% vs.\ \PctTertiaryMen\,\%), así que la brecha cruda subestimaba la desventaja. Al fijar además horas trabajadas, se reduce (verde).
\end{frame}
