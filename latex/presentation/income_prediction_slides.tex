...
\input{../../output/tables/section3_prediction_stats.tex}
\input{../../output/tables/section3_imputation_stats.tex}
  ...
  \begin{block}{Un modelo de la Sección 2 predice mejor que las cinco especificaciones nuevas}
    \begin{itemize}
      ...
      \item Los tres criterios (RMSE de validación, LOOCV, AIC/BIC) coinciden en
        el ranking: una señal de que la comparación es robusta.
    \end{itemize}
  \end{block}
  \vfill
...
\begin{frame}{Comparación de las diez especificaciones}
  \centering
  {\scriptsize \input{../../output/tables/section3_model_comparison_slide.tex}}
...
\begin{frame}{Diagnóstico y resultado de la imputación}
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \centering
      \resizebox{\linewidth}{!}{\input{../../output/tables/section3_imputation_comparison_slide.tex}}
      \vspace{0.4em}
