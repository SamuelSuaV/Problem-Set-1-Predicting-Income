...
\begin{frame}{Perfiles edad--ingreso estimados}
  ...
  {\footnotesize Del perfil condicional no interpretamos su \emph{altura} (nivel de
  ingreso, que depende de las categorías base de horas y tipo de empleo): solo su
  \emph{ancho} (concavidad) y la \emph{edad pico}.}
\end{frame}
